...
CALL INV_TRANS(PSPSCALAR=ZSPECX, PSPVOR=ZVORX, PSPDIV=ZDIVX, PGP=ZGY, KPROMA=JPPROMA, &
  &            KVSETSC=IVSET, KVSETUV=IVSET,LDCOMPUTE=.FALSE.)
...
ADJ_VALUE_1 = SCALPRODGP(ZGY, ZGX, JPPROMA, 3 * JP_NUMLEVELS_G, IGPBLKS, IGPTOT, IGPTOTG, IMYPROC)
...
ADJ_VALUE_2 = SCALPRODSP(ZSPECX, ZSPECY, IVSET, INUM_LEVELS, JP_NUMLEVELS_G, ISPEC2, ISPEC2G, JPTRUNCATION, IMYPROC) + &
