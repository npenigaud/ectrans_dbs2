...
#define TRGTOL_DTYPE MPI_REAL8
    ...
    ENDDO
    CALL MPL_DOUBLESTACK%ALLOCATE(PREEL_REAL,[1_JPIB*KF_FS*D%NLENGTF],SIDE_PARAM=MPL_UPPER)
...
!          & 1_JPIB, ICOMBUFS_OFFSET(ISEND_COUNTS+1)*C_SIZEOF(ZCOMBUFS(1)))
      CALL MPL_DOUBLESTACK%ALLOCATE(ZCOMBUFS,[ICOMBUFS_OFFSET(ISEND_COUNTS+1)],SIDE_PARAM=MPL_LOWER)
    ENDIF
