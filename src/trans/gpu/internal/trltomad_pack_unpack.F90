...
!                  & 1_JPIB, 1_JPIB*KF_FS*D%NLENGTF*C_SIZEOF(PREEL_COMPLEX(1)))
    ...
    CALL MPL_DOUBLESTACK%ALLOCATE(PREEL_COMPLEX,[1_JPIB*KF_FS*D%NLENGTF],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
...
!        & 1_JPIB, 2_JPIB*D%NLENGT1B*KF_FS*C_SIZEOF(FOUBUF(1)))
    CALL MPL_DOUBLESTACK%NEXT_SIDE()
    CALL MPL_DOUBLESTACK%ALLOCATE(FOUBUF,[2_JPIB*D%NLENGT1B*KF_FS],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
