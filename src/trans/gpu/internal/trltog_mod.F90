...
!      CALL MPL_DOUBLESTACK%ALLOCATE(ZCOMBUFR,[ICOMBUFR_OFFSET(IRECV_COUNTS+1)],SIDE_PARAM=MPL_UPPER)
      CALL MPL_DOUBLESTACK%ALLOCATE(ZCOMBUFR,[ICOMBUFR_OFFSET(IRECV_COUNTS+1)],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
    ENDIF
...
!      CALL MPL_DOUBLESTACK%ALLOCATE(ZCOMBUFS,[ICOMBUFS_OFFSET(ISEND_COUNTS+1)],SIDE_PARAM=MPL_UPPER)
      CALL MPL_DOUBLESTACK%ALLOCATE(ZCOMBUFS,[ICOMBUFS_OFFSET(ISEND_COUNTS+1)],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
    ENDIF
