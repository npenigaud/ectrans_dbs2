...
!!    ENDIF
    ...
    IF (KF_FS > 0) THEN
      ...
      CALL GSTATS(106,0)
      CALL FTDIR(ALLOCATOR,HFTDIR,PREEL_REAL,PREEL_COMPLEX,KF_FS,LDCOMPUTE=LLCOMPUTE)
      CALL GSTATS(106,1)

      CALL GSTATS(153,0)

      CALL TRLTOM_PACK(ALLOCATOR,HTRLTOM_PACK,PREEL_COMPLEX,FOUBUF_IN,KF_FS,LDCOMPUTE=LLCOMPUTE)
      CALL TRLTOM(ALLOCATOR,HTRLTOM,FOUBUF_IN,FOUBUF,KF_FS,LDCOMPUTE=LLCOMPUTE)
      CALL TRLTOM_UNPACK(ALLOCATOR,HTRLTOM_UNPACK,FOUBUF,ZINPS,ZINPA,ZINPS0,ZINPA0,KF_FS,KF_UV,LDCOMPUTE=LLCOMPUTE)
      CALL GSTATS(153,1)
