...
!      & 1_JPIB, 2_JPIB*D%NLENGT1B*KF_LEG*C_SIZEOF(FOUBUF_IN(1)))
    CALL MPL_DOUBLESTACK%ALLOCATE(FOUBUF_IN,[2_JPIB*D%NLENGT1B*KF_LEG],SIDE_PARAM=MPL_LOWER)
...
CALL MPL_DOUBLESTACK%ALLOCATE(PREEL_COMPLEX,[1_JPIB*KF_TOTAL*D%NLENGTF],SIDE_PARAM=MPL_LOWER)
#ifdef OMPGPU
