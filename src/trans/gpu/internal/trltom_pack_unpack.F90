...
!        & 1_JPIB, 2_JPIB*D%NLENGT0B*KF_FS*C_SIZEOF(FOUBUF_IN(1)))
    ...
    CALL MPL_DOUBLESTACK%ALLOCATE(FOUBUF_IN,[2_JPIB*D%NLENGT0B*KF_FS],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
...
!!!    CALL MPL_DOUBLESTACK%ALLOCATE(ZINPS,[IIN_SIZE],SIDE_PARAM=MPL_LOWER)
    CALL MPL_DOUBLESTACK%NEXT_SIDE()
    CALL MPL_DOUBLESTACK%ALLOCATE(ZINPS,[IALLOC_SZ],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
...
!    CALL MPL_DOUBLESTACK%ALLOCATE(ZINPA,[IIN_SIZE],SIDE_PARAM=MPL_LOWER)
    CALL MPL_DOUBLESTACK%ALLOCATE(ZINPA,[IALLOC_SZ],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
    IALLOC_POS=IALLOC_POS+IALLOC_SZ
...
!    CALL MPL_DOUBLESTACK%ALLOCATE(ZINPS0,[IIN0_SIZE],SIDE_PARAM=MPL_LOWER)
    CALL MPL_DOUBLESTACK%ALLOCATE(ZINPS0,[IALLOC_SZ],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
    IALLOC_POS=IALLOC_POS+IALLOC_SZ
...
!    CALL MPL_DOUBLESTACK%ALLOCATE(ZINPA0,[IIN0_SIZE],SIDE_PARAM=MPL_LOWER)
    CALL MPL_DOUBLESTACK%ALLOCATE(ZINPA0,[IALLOC_SZ],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
    IALLOC_POS=IALLOC_POS+IALLOC_SZ
