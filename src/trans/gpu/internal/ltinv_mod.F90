...
!        & IALLOC_POS, IALLOC_SZ)
    CALL MPL_DOUBLESTACK%NEXT_SIDE()
    CALL MPL_DOUBLESTACK%ALLOCATE(ZOUTA,[IOUT_SIZE],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
    IALLOC_POS = IALLOC_POS + IALLOC_SZ
...
!        & IALLOC_POS, IALLOC_SZ)
    CALL MPL_DOUBLESTACK%ALLOCATE(ZOUTS,[IOUT_SIZE],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
    IALLOC_POS = IALLOC_POS + IALLOC_SZ
...
!        & IALLOC_POS, IALLOC_SZ)
    CALL MPL_DOUBLESTACK%ALLOCATE(ZOUTA0,[IOUT0_SIZE],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
    IALLOC_POS = IALLOC_POS + IALLOC_SZ
...
!        & IALLOC_POS, IALLOC_SZ)
    CALL MPL_DOUBLESTACK%ALLOCATE(ZOUTS0,[IOUT0_SIZE],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE)
    IALLOC_POS = IALLOC_POS + IALLOC_SZ
