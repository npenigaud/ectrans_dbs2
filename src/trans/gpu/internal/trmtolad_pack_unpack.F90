...
!        & IALLOC_POS, IALLOC_SZ)
    CALL MPL_DOUBLESTACK%ALLOCATE(ZOUTA,[IOUT_SIZE],SIDE_PARAM=MPL_LOWER)   
...
!        & IALLOC_POS, IALLOC_SZ)
    CALL MPL_DOUBLESTACK%ALLOCATE(ZOUTS,[IOUT_SIZE],SIDE_PARAM=MPL_LOWER)
    IALLOC_POS = IALLOC_POS + IALLOC_SZ
...
!        & IALLOC_POS, IALLOC_SZ)
    CALL MPL_DOUBLESTACK%ALLOCATE(ZOUTA0,[IOUT0_SIZE],SIDE_PARAM=MPL_LOWER)
    IALLOC_POS = IALLOC_POS + IALLOC_SZ
...
!        & IALLOC_POS, IALLOC_SZ)
    CALL MPL_DOUBLESTACK%ALLOCATE(ZOUTS0,[IOUT0_SIZE],SIDE_PARAM=MPL_LOWER)
    IALLOC_POS = IALLOC_POS + IALLOC_SZ
...
!                & 1_JPIB, 2_JPIB*D%NLENGT0B*KF_CURRENT*C_SIZEOF(FOUBUF(1)))
  CALL MPL_DOUBLESTACK%ALLOCATE(FOUBUF,[2_JPIB*D%NLENGT0B*KF_CURRENT],SIDE_PARAM=MPL_LOWER) 
