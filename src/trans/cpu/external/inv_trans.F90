...
IF (IF_UV > 0) THEN
  ...
  IF(UBOUND(PSPVOR,1) < IF_UV) THEN
    ...
    CALL ABORT_TRANS('INV_TRANS : PSPVOR TOO SHORT')
  ENDIF
  ...
  IF(UBOUND(PSPDIV,1) < IF_UV) THEN
    ...
    CALL ABORT_TRANS('INV_TRANS : PSPDIV TOO SHORT')
  ENDIF
ENDIF
...
IF(PRESENT(PGPUV)) THEN
  ...
  IF(IUBOUND(4) < NGPBLKS) THEN
    WRITE(NOUT,*)'INV_TRANS:FOURTH DIM. OF PGPUV TOO SMALL ',IUBOUND(4),NGPBLKS
    CALL ABORT_TRANS('INV_TRANS:FOURTH DIMENSION OF PGPUV TOO SMALL ')
  ENDIF
ENDIF
IF(PRESENT(PGP2)) THEN
  IF(.NOT.PRESENT(PSPSC2)) THEN
