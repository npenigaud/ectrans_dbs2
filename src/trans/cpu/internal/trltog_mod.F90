...
CALL MPL_DOUBLESTACK%ALLOCATE(ZCOMBUFS,[YDBUFS%ISENDCOUNT, YDBUFS%INSEND],LBOUNDS=[-1,1],SIDE_PARAM=MPL_LOWER)
CALL MPL_DOUBLESTACK%ALLOCATE(ZCOMBUFR,[YDBUFS%IRECVCOUNT, YDBUFS%INRECV],LBOUNDS=[-1,1],SIDE_PARAM=MPL_UPPER)
