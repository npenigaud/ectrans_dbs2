...
SUBROUTINE TRLTOG(PGLAT, KF_FS, KF_GP, KF_SCALARS_G, KVSET, KPTRGP, PGP, PGPUV, PGP3A, PGP3B, PGP2,LDCOMPUTE)
...
USE MPL_DOUBLESTACK_MOD, ONLY : MPL_DOUBLESTACK,MPL_UPPER,MPL_LOWER
IMPLICIT NONE
