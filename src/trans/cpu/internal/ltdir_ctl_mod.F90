...
CALL MPL_DOUBLESTACK%ALLOCATE(FOUBUF,[MAX(1,IBLEN)],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE,LD_ALLOC=LLCOMPUTE)
!CALL MPL_DOUBLESTACK%ALLOCATE(FOUBUF,MPL_LOWER,[MAX(1,IBLEN)])
...
CALL MPL_DOUBLESTACK%DEALLOCATE(FOUBUF_IN)
...
CALL MPL_DOUBLESTACK%DEALLOCATE(FOUBUF)
CALL GSTATS(103,1)
ENDIF
!     -----------------------------------------------------------------
