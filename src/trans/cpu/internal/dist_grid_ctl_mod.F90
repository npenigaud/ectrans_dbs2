...
REAL(KIND=JPRB),POINTER, CONTIGUOUS :: ZBUF(:,:,:)
REAL(KIND=JPRB),POINTER, CONTIGUOUS :: ZRCV(:,:) ! (D%NGPTOTMX,KFDISTG)
INTEGER(KIND=JPIM) :: JFLD,JB,JA,IGLOFF,IGL1,IGL2,IOFF,ILAST,ILOFF
...
!  ALLOCATE(ZRCV(D%NGPTOTMX,KFDISTG))
  CALL MPL_DOUBLESTACK%ALLOCATE(ZRCV,[D%NGPTOTMX,KFDISTG],SIDE_PARAM=MPL_LOWER)
