...
CALL MPL_DOUBLESTACK%ALLOCATE(ZCOMBUFS,[YDBUFS%ISENDCOUNT, YDBUFS%INSEND],LBOUNDS=[-1,1])
CALL MPL_DOUBLESTACK%NEXT_SIDE()
CALL MPL_DOUBLESTACK%ALLOCATE(ZCOMBUFR,[YDBUFS%IRECVCOUNT, YDBUFS%INRECV],LBOUNDS=[-1,1])
