...
SUBROUTINE TRGTOL(PGLAT, KF_FS, KF_GP, KF_SCALARS_G, KVSET, KPTRGP, PGP, PGPUV, PGP3A, PGP3B, PGP2,LDCOMPUTE)
...
USE TPM_DISTR       ,ONLY : D, MTAGGL, NPRCIDS, MYPROC, NPROC
...
CALL MPL_DOUBLESTACK%ALLOCATE(ZCOMBUFS,[YDBUFS%ISENDCOUNT, YDBUFS%INSEND],LBOUNDS=[-1,1],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE,LD_ALLOC=LLCOMPUTE)
CALL MPL_DOUBLESTACK%NEXT_SIDE()
CALL MPL_DOUBLESTACK%ALLOCATE(ZCOMBUFR,[YDBUFS%IRECVCOUNT, YDBUFS%INRECV],LBOUNDS=[-1,1],SIDE_PARAM=MPL_DOUBLESTACK%CURRENT_SIDE,LD_ALLOC=LLCOMPUTE)
...
CALL MPL_DOUBLESTACK%DEALLOCATE(ZCOMBUFR)
CALL MPL_DOUBLESTACK%DEALLOCATE(ZCOMBUFS)
ENDIF
END ASSOCIATE
