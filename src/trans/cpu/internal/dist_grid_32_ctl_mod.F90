...
!CALL MPL_DOUBLESTACK%ALLOCATE(ZBUF,[D%NGPTOTMX,IMYFIELDS,NPROC])
!CALL MPL_DOUBLESTACK%ALLOCATE(ZRCV,[D%NGPTOTMX,KFDISTG])
...
!        CALL MPL_DOUBLESTACK%ALLOCATE(ZRCV2,[D%NGPTOTMX,IFLDSFROM(JROC)])
